...
const Login = () => {
  return (
    <>
      <section className="min-w-screen min-h-screen mx-auto flex flex-col pt-10 items-center bg-[#0B121C] md:pt-[125px] md:px-5 dark:bg-gray-500">
        ...
        <div className="mt-10 grid bg-white rounded-3xl shadow-lg shadow-black md:grid-cols-2 dark:bg-[#0B121C]">
