...
export const TodoList = () => {
  ...
  // const appendToStorage = (name: any, data: any) => {
  ...
  const onSubmit = (values: Values, { resetForm }: ResetForm) => {
    setTodos((current: [string]) => [...current, values]);
    resetForm();
    setShowNew(false);
  };
  ...
  const handleRemove = (id: string) => {
    // Creates new array by pushing in all the elements that pass the check if our current id doesn't match any of the iterated id's.
